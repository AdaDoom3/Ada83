...
IF FILES(I).EOF THEN RAISE END_ERROR;END IF;
...
BEGIN
FOR I IN 0..15 LOOP
FILES(I):=(-1,IN_FILE,0,FALSE,TRUE);
END LOOP;
FILES(0):=(0,IN_FILE,0,TRUE,FALSE);
FILES(1):=(1,OUT_FILE,0,TRUE,FALSE);
FILES(2):=(2,OUT_FILE,0,TRUE,FALSE);
END SEQUENTIAL_IO;
