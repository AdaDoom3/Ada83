...
IF FROM>FILES(I).SZ THEN RAISE END_ERROR;END IF;
FILES(I).IDX:=FROM+1;
END IF;
END READ;
...
IF NOT FILES(I).OPEN THEN RAISE STATUS_ERROR;END IF;
IF FILES(I).M=OUT_FILE THEN RAISE MODE_ERROR;END IF;
IF FILES(I).IDX>FILES(I).SZ THEN RAISE END_ERROR;END IF;
...
IF NOT FILES(I).OPEN THEN RAISE STATUS_ERROR;END IF;
IF FILES(I).M=IN_FILE THEN RAISE MODE_ERROR;END IF;
IF FILES(I).IDX>FILES(I).SZ THEN FILES(I).SZ:=FILES(I).IDX;END IF;
FILES(I).IDX:=FILES(I).IDX+1;
END IF;
END WRITE;
