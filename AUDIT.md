...
4. **Remaining Class C failures**: down to nine, all classified (see
   checklist.txt): seven are officially withdrawn ACVC 1.11 tests
   (c55b06a c98003b cb7001a cc1226b cd4024b cd4031a ce3902b); two
   need §13 representation work — `cd1c04e` (rep clauses must override
   inherited derived-type component layout) and `cda201a` (pragma PACK
   bit-packing; `is_packed` is recorded but never consumed).
